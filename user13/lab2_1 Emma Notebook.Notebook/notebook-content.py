...
# META   "dependencies": {
# META     "lakehouse": {
# META       "default_lakehouse": "135c0a96-7b55-473c-a655-0e03c52dec80",
# META       "default_lakehouse_name": "lh_tpch13",
...
SELECT * FROM lh_tpch13.customer LIMIT 1
...
# MAGIC %%sql 
# MAGIC CREATE TABLE lh_tpch13.customer_sf1000 AS
# MAGIC SELECT * FROM lh_tpch13.customer;
# MAGIC 
# MAGIC CREATE TABLE lh_tpch13.lineitem_sf1000 AS
# MAGIC SELECT * FROM lh_tpch13.lineitem;
# MAGIC 
# MAGIC CREATE TABLE lh_tpch13.nation_sf1000 AS
# MAGIC SELECT * FROM lh_tpch13.nation;
# MAGIC 
# MAGIC CREATE TABLE lh_tpch13.orders_sf1000 AS
# MAGIC SELECT * FROM lh_tpch13.orders;
# MAGIC 
# MAGIC CREATE TABLE lh_tpch13.part_sf1000 AS
# MAGIC SELECT * FROM lh_tpch13.part;
# MAGIC 
# MAGIC CREATE TABLE lh_tpch13.partsupp_sf1000 AS
# MAGIC SELECT * FROM lh_tpch13.partsupp;
# MAGIC 
# MAGIC CREATE TABLE lh_tpch13.region_sf1000 AS
# MAGIC SELECT * FROM lh_tpch13.region;
# MAGIC 
# MAGIC CREATE TABLE lh_tpch13.supplier_sf1000 AS
# MAGIC SELECT * FROM lh_tpch13.supplier;
...
df = spark.sql("SELECT * FROM lh_tpch13.customer_sf1 LIMIT 1000")
display(df)
...
pip install https://aka.ms/chat_magics-0
...
def filter_for_case_types(df, column):
    return df[df[column] == 721]
...
df = spark.sql("SELECT * FROM lh_tpch13.customer_sf1000 LIMIT 1000")
display(df)
